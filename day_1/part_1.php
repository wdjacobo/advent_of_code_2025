...
<body>
    <p class="mt-3 ms-3"><span class="solution"><?= "The door's password is: $pass"; ?></span>... But it won't open.
    <p>
    <p class="ms-3"><a href="part_2.php">Check part 2</a></p>
